...
export default class Floor {
  ...
  setCircles() {
    ...
    const material = new THREE.MeshStandardMaterial({ color: 0x1b2aab });
    const material2 = new THREE.MeshStandardMaterial({ color: 0xee82ee });
    const material3 = new THREE.MeshStandardMaterial({ color: 0x0bdb3c });
